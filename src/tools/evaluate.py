...
def interpret_detection(detection_results, class_names, score_threshold=0.5):
    """
    Args:
        detection_results: Dict with 'boxes', 'labels', 'scores'
    ...
    print(f"\n{'='*60}")
    print(f"Total number of detection: {len(boxes)}")
    ...
    print(f"Threshold >= {score_threshold}: {len(filtered_boxes)}\n")
